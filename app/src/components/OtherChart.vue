...
export default {
  ...
  setup() {
    ...
    async function getData() {
      try {
        console.log('Fetching data for doughnut chart...')
        ...
        if (chartCanvas.value) {
          ...
          console.log('Doughnut chart instance created:', chartInstance)
        }
    ...
    onMounted(() => {
      console.log('Doughnut component mounted')
      getData()
    })

    onUnmounted(() => {
      console.log('Doughnut component unmounted, destroying chart')
      if (chartInstance) {
        chartInstance.destroy()
        chartInstance = null
      }
